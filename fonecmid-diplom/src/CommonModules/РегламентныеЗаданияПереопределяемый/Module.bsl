...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ВКМ_ОтправкаСообщенийВТелеграмЧат;
	Настройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ВКМ_ОтправлятьСообщенияВТелеграмЧат;
	Настройка.ДоступноВМоделиСервиса = Ложь;
